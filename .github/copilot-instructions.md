...
## 2. Workflow des features
Avant chaque feature ou tache à réaliser: 
- obligatoire: vérifier que tu n'es pas sur la main.
- si tu es sur la main, tu vas me demander l'issue à réaliser.
- tu vas attendre ma réponse.
- l'issue doit etre sur un id, ou un lien github ou gitlab, si ce n'est pas le cas, tu refuses de continuer, et tu me redemandes l'issue.
